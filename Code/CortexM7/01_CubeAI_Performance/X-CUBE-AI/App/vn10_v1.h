...
#ifndef __AI_VN10_V1_H__
#define __AI_VN10_V1_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_VN10_V1_MODEL_NAME          "vn10_v1"

#define AI_VN10_V1_ACTIVATIONS_ALIGNMENT   (4)

#define AI_VN10_V1_IN_NUM       (1)
#define AI_VN10_V1_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 127, 1, 1, 1, NULL), \
}
#define AI_VN10_V1_IN_SIZE { \
  (127 * 1 * 1), \
}
#define AI_VN10_V1_IN_1_SIZE  (127 * 1 * 1)
#define AI_VN10_V1_IN_1_SIZE_BYTES  ((127 * 1 * 1) * 4)





#define AI_VN10_V1_OUT_NUM      (1)
#define AI_VN10_V1_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 3, 1, 1, 1, NULL), \
}
#define AI_VN10_V1_OUT_SIZE { \
  (3 * 1 * 1), \
}
#define AI_VN10_V1_OUT_1_SIZE  (3 * 1 * 1)
#define AI_VN10_V1_OUT_1_SIZE_BYTES  ((3 * 1 * 1) * 4)

#define AI_VN10_V1_N_NODES (10)
 ...
 * @ref ai_vn10_v1_create. Both the activations memory buffer 
 ...
 * using @ref ai_vn10_v1_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_VN10_V1_*
 * defines into file @ref vn10_v1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_vn10_v1_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_VN10_V1_H__*/
