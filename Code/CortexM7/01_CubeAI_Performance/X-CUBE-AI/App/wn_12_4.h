...
#ifndef __AI_WN_12_4_H__
#define __AI_WN_12_4_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WN_12_4_MODEL_NAME          "wn_12_4"

#define AI_WN_12_4_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WN_12_4_IN_NUM       (1)
#define AI_WN_12_4_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 253, 1, 1, 1, NULL), \
}
#define AI_WN_12_4_IN_SIZE { \
  (253 * 1 * 1), \
}
#define AI_WN_12_4_IN_1_SIZE  (253 * 1 * 1)
#define AI_WN_12_4_IN_1_SIZE_BYTES  ((253 * 1 * 1) * 4)





#define AI_WN_12_4_OUT_NUM      (1)
#define AI_WN_12_4_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_WN_12_4_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_WN_12_4_OUT_1_SIZE  (1 * 1 * 1)
#define AI_WN_12_4_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_WN_12_4_N_NODES (12)
 ...
 * @ref ai_wn_12_4_create. Both the activations memory buffer 
 ...
 * using @ref ai_wn_12_4_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_WN_12_4_*
 * defines into file @ref wn_12_4.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wn_12_4_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WN_12_4_H__*/
