...
#ifndef __AI_WN12_3_H__
#define __AI_WN12_3_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WN12_3_MODEL_NAME          "wn12_3"

#define AI_WN12_3_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WN12_3_IN_NUM       (1)
#define AI_WN12_3_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 253, 1, 1, 1, NULL), \
}
#define AI_WN12_3_IN_SIZE { \
  (253 * 1 * 1), \
}
#define AI_WN12_3_IN_1_SIZE  (253 * 1 * 1)
#define AI_WN12_3_IN_1_SIZE_BYTES  ((253 * 1 * 1) * 4)

#define AI_WN12_3_INPUTS_IN_ACTIVATIONS     (4)

#define AI_WN12_3_OUTPUTS_IN_ACTIVATIONS    (4)

#define AI_WN12_3_OUT_NUM      (1)
#define AI_WN12_3_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_WN12_3_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_WN12_3_OUT_1_SIZE  (1 * 1 * 1)
#define AI_WN12_3_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_WN12_3_N_NODES (12)
 ...
 */
AI_API_ENTRY
ai_error ai_wn12_3_get_error(ai_handle network);
 ...
 * using @ref ai_wn12_3_get_error
 */
AI_API_ENTRY
ai_bool ai_wn12_3_init(
 ...
 * header generated by the code generation tool. See AI_WN12_3_*
 * defines into file @ref wn12_3.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wn12_3_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WN12_3_H__*/
