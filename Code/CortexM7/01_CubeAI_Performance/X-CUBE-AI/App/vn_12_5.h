...
#ifndef __AI_VN_12_5_H__
#define __AI_VN_12_5_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_VN_12_5_MODEL_NAME          "vn_12_5"

#define AI_VN_12_5_ACTIVATIONS_ALIGNMENT   (4)

#define AI_VN_12_5_IN_NUM       (1)
#define AI_VN_12_5_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 253, 1, 1, 1, NULL), \
}
#define AI_VN_12_5_IN_SIZE { \
  (253 * 1 * 1), \
}
#define AI_VN_12_5_IN_1_SIZE  (253 * 1 * 1)
#define AI_VN_12_5_IN_1_SIZE_BYTES  ((253 * 1 * 1) * 4)





#define AI_VN_12_5_OUT_NUM      (1)
#define AI_VN_12_5_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_VN_12_5_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_VN_12_5_OUT_1_SIZE  (1 * 1 * 1)
#define AI_VN_12_5_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_VN_12_5_N_NODES (12)
 ...
 * @ref ai_vn_12_5_create. Both the activations memory buffer 
 ...
 * using @ref ai_vn_12_5_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_VN_12_5_*
 * defines into file @ref vn_12_5.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_vn_12_5_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_VN_12_5_H__*/
