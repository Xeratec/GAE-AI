...
#ifndef __AI_WN_12_4_TFL_H__
#define __AI_WN_12_4_TFL_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WN_12_4_TFL_MODEL_NAME          "wn_12_4_tfl"

#define AI_WN_12_4_TFL_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WN_12_4_TFL_IN_NUM       (1)
#define AI_WN_12_4_TFL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 253, 1, 1, NULL), \
}
#define AI_WN_12_4_TFL_IN_SIZE { \
  (1 * 253 * 1), \
}
#define AI_WN_12_4_TFL_IN_1_SIZE  (1 * 253 * 1)
#define AI_WN_12_4_TFL_IN_1_SIZE_BYTES  ((1 * 253 * 1) * 4)





#define AI_WN_12_4_TFL_OUT_NUM      (1)
#define AI_WN_12_4_TFL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 249, 1, 1, NULL), \
}
#define AI_WN_12_4_TFL_OUT_SIZE { \
  (1 * 249 * 1), \
}
#define AI_WN_12_4_TFL_OUT_1_SIZE  (1 * 249 * 1)
#define AI_WN_12_4_TFL_OUT_1_SIZE_BYTES  ((1 * 249 * 1) * 4)

#define AI_WN_12_4_TFL_N_NODES (12)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup wn_12_4_tfl
 ...
 */
AI_API_ENTRY
ai_bool ai_wn_12_4_tfl_get_info(
 ...
 */
AI_API_ENTRY
ai_error ai_wn_12_4_tfl_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_wn_12_4_tfl_create(
 ...
 * using @ref ai_wn_12_4_tfl_get_error
 */
AI_API_ENTRY
ai_bool ai_wn_12_4_tfl_init(
 ...
 * header generated by the code generation tool. See AI_WN_12_4_TFL_*
 * defines into file @ref wn_12_4_tfl.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wn_12_4_tfl_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WN_12_4_TFL_H__*/
