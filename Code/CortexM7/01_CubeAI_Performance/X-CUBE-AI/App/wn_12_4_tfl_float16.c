...
#define AI_NET_OBJ_INSTANCE g_wn_12_4_tfl_float16
 
#undef AI_WN_12_4_TFL_FLOAT16_MODEL_SIGNATURE
#define AI_WN_12_4_TFL_FLOAT16_MODEL_SIGNATURE     "aad9a323cd766152ffe975f1bf0eb03a"
...
#define AI_TOOLS_DATE_TIME   "Mon Dec  7 21:09:11 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_WN_12_4_TFL_FLOAT16_N_BATCHES
#define AI_WN_12_4_TFL_FLOAT16_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 8032, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_4_TFL_FLOAT16_IN_NUM, &input_1_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_4_TFL_FLOAT16_OUT_NUM, &conv2d_23_output),
  &conv2d_1_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool wn_12_4_tfl_float16_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_WN_12_4_TFL_FLOAT16_ACTIVATIONS_ALIGNMENT));
...
AI_DECLARE_STATIC
ai_bool wn_12_4_tfl_float16_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_WN_12_4_TFL_FLOAT16_MODEL_NAME,
      .model_signature   = AI_WN_12_4_TFL_FLOAT16_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= wn_12_4_tfl_float16_configure_weights(net_ctx, &params->params);
  ok &= wn_12_4_tfl_float16_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_wn_12_4_tfl_float16_forward(ai_handle network, const ai_buffer* input)
{
