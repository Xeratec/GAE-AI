/**
  ******************************************************************************
  * @file    wn_12_4_tfl_float16.h
  * @author  AST Embedded Analytics Research Platform
  * @date    Mon Dec  7 21:09:11 2020
...
#ifndef __AI_WN_12_4_TFL_FLOAT16_H__
#define __AI_WN_12_4_TFL_FLOAT16_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WN_12_4_TFL_FLOAT16_MODEL_NAME          "wn_12_4_tfl_float16"

#define AI_WN_12_4_TFL_FLOAT16_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WN_12_4_TFL_FLOAT16_IN_NUM       (1)
#define AI_WN_12_4_TFL_FLOAT16_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 253, 1, 1, NULL), \
}
#define AI_WN_12_4_TFL_FLOAT16_IN_SIZE { \
  (1 * 253 * 1), \
}
#define AI_WN_12_4_TFL_FLOAT16_IN_1_SIZE  (1 * 253 * 1)
#define AI_WN_12_4_TFL_FLOAT16_IN_1_SIZE_BYTES  ((1 * 253 * 1) * 4)





#define AI_WN_12_4_TFL_FLOAT16_OUT_NUM      (1)
#define AI_WN_12_4_TFL_FLOAT16_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 249, 1, 1, NULL), \
}
#define AI_WN_12_4_TFL_FLOAT16_OUT_SIZE { \
  (1 * 249 * 1), \
}
#define AI_WN_12_4_TFL_FLOAT16_OUT_1_SIZE  (1 * 249 * 1)
#define AI_WN_12_4_TFL_FLOAT16_OUT_1_SIZE_BYTES  ((1 * 249 * 1) * 4)

#define AI_WN_12_4_TFL_FLOAT16_N_NODES (12)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup wn_12_4_tfl_float16
 ...
 */
AI_API_ENTRY
ai_bool ai_wn_12_4_tfl_float16_get_info(
 ...
 */
AI_API_ENTRY
ai_error ai_wn_12_4_tfl_float16_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_wn_12_4_tfl_float16_create(
 ...
 */
AI_API_ENTRY
ai_handle ai_wn_12_4_tfl_float16_destroy(ai_handle network);

/*!
 * @brief Initialize the data structures of the network.
 * @ingroup wn_12_4_tfl_float16
 * @details This API initialized the network after a successfull
 * @ref ai_wn_12_4_tfl_float16_create. Both the activations memory buffer 
 ...
 * using @ref ai_wn_12_4_tfl_float16_get_error
 */
AI_API_ENTRY
ai_bool ai_wn_12_4_tfl_float16_init(
 ...
 * header generated by the code generation tool. See AI_WN_12_4_TFL_FLOAT16_*
 * defines into file @ref wn_12_4_tfl_float16.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wn_12_4_tfl_float16_run(
 ...
 */
AI_API_ENTRY
ai_i32 ai_wn_12_4_tfl_float16_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WN_12_4_TFL_FLOAT16_H__*/
