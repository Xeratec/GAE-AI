...
#ifndef __AI_WN12_H__
#define __AI_WN12_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WN12_MODEL_NAME          "wn12"

#define AI_WN12_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WN12_IN_NUM       (1)
#define AI_WN12_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 253, 1, 1, 1, NULL), \
}
#define AI_WN12_IN_SIZE { \
  (253 * 1 * 1), \
}
#define AI_WN12_IN_1_SIZE  (253 * 1 * 1)
#define AI_WN12_IN_1_SIZE_BYTES  ((253 * 1 * 1) * 4)

#define AI_WN12_INPUTS_IN_ACTIVATIONS     (4)

#define AI_WN12_OUTPUTS_IN_ACTIVATIONS    (4)

#define AI_WN12_OUT_NUM      (1)
#define AI_WN12_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_WN12_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_WN12_OUT_1_SIZE  (1 * 1 * 1)
#define AI_WN12_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_WN12_N_NODES (12)
 ...
 * @ref ai_wn12_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_WN12_*
 * defines into file @ref wn12.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
