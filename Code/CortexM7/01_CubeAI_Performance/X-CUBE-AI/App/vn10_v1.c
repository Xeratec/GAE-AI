...
#define AI_NET_OBJ_INSTANCE g_vn10_v1
 
#undef AI_VN10_V1_MODEL_SIGNATURE
#define AI_VN10_V1_MODEL_SIGNATURE     "d06a0044a52f4b45781e6e9117399196"
...
#define AI_TOOLS_DATE_TIME   "Fri Nov 20 20:19:44 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_VN10_V1_N_BATCHES
#define AI_VN10_V1_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 4256, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_VN10_V1_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_VN10_V1_OUT_NUM, &conv1d_9_output),
  &conv1d_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool vn10_v1_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_VN10_V1_ACTIVATIONS_ALIGNMENT));
...
AI_DECLARE_STATIC
ai_bool vn10_v1_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_VN10_V1_MODEL_NAME,
      .model_signature   = AI_VN10_V1_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_vn10_v1_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_vn10_v1_create(
...
AI_API_ENTRY
ai_handle ai_vn10_v1_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_vn10_v1_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= vn10_v1_configure_weights(net_ctx, &params->params);
  ok &= vn10_v1_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_vn10_v1_forward(ai_handle network, const ai_buffer* input)
{
