...
#ifndef __AI_NOD_TFL_H__
#define __AI_NOD_TFL_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_NOD_TFL_MODEL_NAME          "nod_tfl"

#define AI_NOD_TFL_ACTIVATIONS_ALIGNMENT   (4)

#define AI_NOD_TFL_IN_NUM       (1)
#define AI_NOD_TFL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 253, 1, 1, NULL), \
}
#define AI_NOD_TFL_IN_SIZE { \
  (1 * 253 * 1), \
}
#define AI_NOD_TFL_IN_1_SIZE  (1 * 253 * 1)
#define AI_NOD_TFL_IN_1_SIZE_BYTES  ((1 * 253 * 1) * 4)





#define AI_NOD_TFL_OUT_NUM      (1)
#define AI_NOD_TFL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 249, 1, 1, NULL), \
}
#define AI_NOD_TFL_OUT_SIZE { \
  (1 * 249 * 1), \
}
#define AI_NOD_TFL_OUT_1_SIZE  (1 * 249 * 1)
#define AI_NOD_TFL_OUT_1_SIZE_BYTES  ((1 * 249 * 1) * 4)

#define AI_NOD_TFL_N_NODES (12)
 ...
 * @ref ai_nod_tfl_create. Both the activations memory buffer 
 ...
 * using @ref ai_nod_tfl_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NOD_TFL_*
 * defines into file @ref nod_tfl.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_nod_tfl_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_NOD_TFL_H__*/
