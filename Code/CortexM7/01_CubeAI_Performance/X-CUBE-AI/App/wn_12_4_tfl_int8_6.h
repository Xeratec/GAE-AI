...
#ifndef __AI_WN_12_4_TFL_INT8_6_H__
#define __AI_WN_12_4_TFL_INT8_6_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WN_12_4_TFL_INT8_6_MODEL_NAME          "wn_12_4_tfl_int8_6"

#define AI_WN_12_4_TFL_INT8_6_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WN_12_4_TFL_INT8_6_IN_NUM       (1)
#define AI_WN_12_4_TFL_INT8_6_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 1, 253, 1, 1, NULL), \
}
#define AI_WN_12_4_TFL_INT8_6_IN_SIZE { \
  (1 * 253 * 1), \
}
#define AI_WN_12_4_TFL_INT8_6_IN_1_SIZE  (1 * 253 * 1)
#define AI_WN_12_4_TFL_INT8_6_IN_1_SIZE_BYTES  ((1 * 253 * 1) * 1)





#define AI_WN_12_4_TFL_INT8_6_OUT_NUM      (1)
#define AI_WN_12_4_TFL_INT8_6_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 1, 229, 1, 1, NULL), \
}
#define AI_WN_12_4_TFL_INT8_6_OUT_SIZE { \
  (1 * 229 * 1), \
}
#define AI_WN_12_4_TFL_INT8_6_OUT_1_SIZE  (1 * 229 * 1)
#define AI_WN_12_4_TFL_INT8_6_OUT_1_SIZE_BYTES  ((1 * 229 * 1) * 1)

#define AI_WN_12_4_TFL_INT8_6_N_NODES (12)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup wn_12_4_tfl_int8_6
 ...
 * @ref ai_wn_12_4_tfl_int8_6_create. Both the activations memory buffer 
 ...
 * using @ref ai_wn_12_4_tfl_int8_6_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_WN_12_4_TFL_INT8_6_*
 * defines into file @ref wn_12_4_tfl_int8_6.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wn_12_4_tfl_int8_6_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WN_12_4_TFL_INT8_6_H__*/
