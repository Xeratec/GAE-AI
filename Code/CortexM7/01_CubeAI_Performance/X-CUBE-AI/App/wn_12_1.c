...
#define AI_NET_OBJ_INSTANCE g_wn_12_1
 
#undef AI_WN_12_1_MODEL_SIGNATURE
#define AI_WN_12_1_MODEL_SIGNATURE     "2a1aec9e56f153179b012eebb5fae626"
...
#define AI_TOOLS_DATE_TIME   "Thu Dec 10 18:06:06 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_WN_12_1_N_BATCHES
#define AI_WN_12_1_N_BATCHES         (1)
...
AI_ARRAY_OBJ_DECLARE(
  ...
  NULL, NULL, 1544, AI_STATIC)

/* Array#30 */
AI_ARRAY_OBJ_DECLARE(
  conv1d_5_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 1032, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 255), AI_STRIDE_INIT(4, 4, 4, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 253), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 249), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 241), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 225), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 193), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 129), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 123), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 115), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 99), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 67), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 8416, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_1_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_1_OUT_NUM, &conv1d_11_output),
  &conv1d_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool wn_12_1_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_WN_12_1_ACTIVATIONS_ALIGNMENT));
...

  {
    ...
    conv1d_6_output_array.data = AI_PTR(activations + 4128);
    conv1d_6_output_array.data_start = AI_PTR(activations + 4128);
    conv1d_7_output_array.data = AI_PTR(activations + 0);
    conv1d_7_output_array.data_start = AI_PTR(activations + 0);
    conv1d_8_output_array.data = AI_PTR(activations + 3936);
    conv1d_8_output_array.data_start = AI_PTR(activations + 3936);
    conv1d_9_output_array.data = AI_PTR(activations + 0);
    conv1d_9_output_array.data_start = AI_PTR(activations + 0);
    conv1d_10_output_array.data = AI_PTR(activations + 3168);
    conv1d_10_output_array.data_start = AI_PTR(activations + 3168);
...
AI_DECLARE_STATIC
ai_bool wn_12_1_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_WN_12_1_MODEL_NAME,
      .model_signature   = AI_WN_12_1_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_wn_12_1_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_wn_12_1_create(
...
AI_API_ENTRY
ai_handle ai_wn_12_1_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_wn_12_1_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= wn_12_1_configure_weights(net_ctx, &params->params);
  ok &= wn_12_1_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_wn_12_1_forward(ai_handle network, const ai_buffer* input)
{
