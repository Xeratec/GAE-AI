...
#define AI_NOD_MODEL_NAME          "nod"

#define AI_NOD_ACTIVATIONS_ALIGNMENT   (4)

#define AI_NOD_IN_NUM       (1)
#define AI_NOD_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 253, 1, 1, 1, NULL), \
}
#define AI_NOD_IN_SIZE { \
  (253 * 1 * 1), \
}
#define AI_NOD_IN_1_SIZE  (253 * 1 * 1)
#define AI_NOD_IN_1_SIZE_BYTES  ((253 * 1 * 1) * 4)





#define AI_NOD_OUT_NUM      (1)
#define AI_NOD_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 229, 1, 1, 1, NULL), \
}
#define AI_NOD_OUT_SIZE { \
  (229 * 1 * 1), \
}
#define AI_NOD_OUT_1_SIZE  (229 * 1 * 1)
#define AI_NOD_OUT_1_SIZE_BYTES  ((229 * 1 * 1) * 4)

#define AI_NOD_N_NODES (12)
 ...
 * @ref ai_nod_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_NOD_*
 * defines into file @ref nod.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
