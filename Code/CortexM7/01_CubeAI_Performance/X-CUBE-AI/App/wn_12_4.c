...
#define AI_NET_OBJ_INSTANCE g_wn_12_4
 
#undef AI_WN_12_4_MODEL_SIGNATURE
#define AI_WN_12_4_MODEL_SIGNATURE     "1184d6827e11573385514aabf453942e"
...
#define AI_TOOLS_DATE_TIME   "Thu Dec 10 18:05:52 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_WN_12_4_N_BATCHES
#define AI_WN_12_4_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 4176, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_4_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_4_OUT_NUM, &conv1d_11_output),
  &conv1d_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool wn_12_4_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_WN_12_4_ACTIVATIONS_ALIGNMENT));
...

  {
    ...
    conv1d_output_array.data = AI_PTR(activations + 160);
    conv1d_output_array.data_start = AI_PTR(activations + 160);
    conv1d_1_output_array.data = AI_PTR(activations + 128);
    conv1d_1_output_array.data_start = AI_PTR(activations + 128);
    conv1d_2_output_array.data = AI_PTR(activations + 96);
    conv1d_2_output_array.data_start = AI_PTR(activations + 96);
    conv1d_3_output_array.data = AI_PTR(activations + 64);
    conv1d_3_output_array.data_start = AI_PTR(activations + 64);
    conv1d_4_output_array.data = AI_PTR(activations + 32);
    conv1d_4_output_array.data_start = AI_PTR(activations + 32);
    conv1d_5_output_array.data = AI_PTR(activations + 0);
    conv1d_5_output_array.data_start = AI_PTR(activations + 0);
    conv1d_6_output_array.data = AI_PTR(activations + 2032);
    conv1d_6_output_array.data_start = AI_PTR(activations + 2032);
    conv1d_7_output_array.data = AI_PTR(activations + 0);
    conv1d_7_output_array.data_start = AI_PTR(activations + 0);
    conv1d_8_output_array.data = AI_PTR(activations + 1936);
    conv1d_8_output_array.data_start = AI_PTR(activations + 1936);
    conv1d_9_output_array.data = AI_PTR(activations + 0);
    conv1d_9_output_array.data_start = AI_PTR(activations + 0);
    conv1d_10_output_array.data = AI_PTR(activations + 1552);
    conv1d_10_output_array.data_start = AI_PTR(activations + 1552);
    conv1d_11_output_array.data = AI_PTR(NULL);
    conv1d_11_output_array.data_start = AI_PTR(NULL);
...
AI_DECLARE_STATIC
ai_bool wn_12_4_configure_weights(
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    conv1d_11_bias_array.data = AI_PTR(weights + 2192);
    conv1d_11_bias_array.data_start = AI_PTR(weights + 2192);
    conv1d_11_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_11_weights_array.data = AI_PTR(weights + 2144);
    conv1d_11_weights_array.data_start = AI_PTR(weights + 2144);
    conv1d_10_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_10_bias_array.data = AI_PTR(weights + 2128);
    conv1d_10_bias_array.data_start = AI_PTR(weights + 2128);
    conv1d_10_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_10_weights_array.data = AI_PTR(weights + 1936);
    conv1d_10_weights_array.data_start = AI_PTR(weights + 1936);
    conv1d_9_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_9_bias_array.data = AI_PTR(weights + 1920);
    conv1d_9_bias_array.data_start = AI_PTR(weights + 1920);
    conv1d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_9_weights_array.data = AI_PTR(weights + 1728);
    conv1d_9_weights_array.data_start = AI_PTR(weights + 1728);
    conv1d_8_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_8_bias_array.data = AI_PTR(weights + 1712);
    conv1d_8_bias_array.data_start = AI_PTR(weights + 1712);
    conv1d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_8_weights_array.data = AI_PTR(weights + 1520);
    conv1d_8_weights_array.data_start = AI_PTR(weights + 1520);
    conv1d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_7_bias_array.data = AI_PTR(weights + 1504);
    conv1d_7_bias_array.data_start = AI_PTR(weights + 1504);
    conv1d_7_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_7_weights_array.data = AI_PTR(weights + 1312);
    conv1d_7_weights_array.data_start = AI_PTR(weights + 1312);
    conv1d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_6_bias_array.data = AI_PTR(weights + 1296);
    conv1d_6_bias_array.data_start = AI_PTR(weights + 1296);
    conv1d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_6_weights_array.data = AI_PTR(weights + 1104);
    conv1d_6_weights_array.data_start = AI_PTR(weights + 1104);
    conv1d_5_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_5_bias_array.data = AI_PTR(weights + 1088);
    conv1d_5_bias_array.data_start = AI_PTR(weights + 1088);
    conv1d_5_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_5_weights_array.data = AI_PTR(weights + 896);
    conv1d_5_weights_array.data_start = AI_PTR(weights + 896);
    conv1d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_4_bias_array.data = AI_PTR(weights + 880);
    conv1d_4_bias_array.data_start = AI_PTR(weights + 880);
    conv1d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_4_weights_array.data = AI_PTR(weights + 688);
    conv1d_4_weights_array.data_start = AI_PTR(weights + 688);
    conv1d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_3_bias_array.data = AI_PTR(weights + 672);
    conv1d_3_bias_array.data_start = AI_PTR(weights + 672);
    conv1d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_3_weights_array.data = AI_PTR(weights + 480);
    conv1d_3_weights_array.data_start = AI_PTR(weights + 480);
    conv1d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_bias_array.data = AI_PTR(weights + 464);
    conv1d_2_bias_array.data_start = AI_PTR(weights + 464);
    conv1d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_weights_array.data = AI_PTR(weights + 272);
    conv1d_2_weights_array.data_start = AI_PTR(weights + 272);
    conv1d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_bias_array.data = AI_PTR(weights + 256);
    conv1d_1_bias_array.data_start = AI_PTR(weights + 256);
    conv1d_1_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_weights_array.data = AI_PTR(weights + 64);
    conv1d_1_weights_array.data_start = AI_PTR(weights + 64);
    conv1d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_bias_array.data = AI_PTR(weights + 48);
    conv1d_bias_array.data_start = AI_PTR(weights + 48);
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_WN_12_4_MODEL_NAME,
      .model_signature   = AI_WN_12_4_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_wn_12_4_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_wn_12_4_create(
...
AI_API_ENTRY
ai_handle ai_wn_12_4_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_wn_12_4_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= wn_12_4_configure_weights(net_ctx, &params->params);
  ok &= wn_12_4_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_wn_12_4_forward(ai_handle network, const ai_buffer* input)
{
