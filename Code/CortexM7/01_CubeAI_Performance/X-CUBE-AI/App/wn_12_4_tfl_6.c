...
#define AI_NET_OBJ_INSTANCE g_wn_12_4_tfl_6
 
#undef AI_WN_12_4_TFL_6_MODEL_SIGNATURE
#define AI_WN_12_4_TFL_6_MODEL_SIGNATURE     "d9fcd18dcf610909d05fccc6f6264c33"
...
#define AI_TOOLS_DATE_TIME   "Thu Dec 10 18:06:28 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_WN_12_4_TFL_6_N_BATCHES
#define AI_WN_12_4_TFL_6_N_BATCHES         (1)
...
AI_STATIC ai_array input_3_output_array;   /* Array #24 */
...
AI_STATIC ai_tensor input_3_output;   /* Tensor #24 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 247, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3952),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 245, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3920),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 243, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3888),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 241, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3856),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 239, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3824),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 237, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3792),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 235, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3760),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 233, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3728),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 231, 1), AI_STRIDE_INIT(4, 4, 4, 16, 3696),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 229, 1), AI_STRIDE_INIT(4, 4, 4, 4, 916),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 8000, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_4_TFL_6_IN_NUM, &input_3_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_12_4_TFL_6_OUT_NUM, &conv2d_23_output),
  &conv2d_1_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool wn_12_4_tfl_6_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_WN_12_4_TFL_6_ACTIVATIONS_ALIGNMENT));
...

  {
    ...
    conv2d_7_output_array.data = AI_PTR(activations + 3952);
    conv2d_7_output_array.data_start = AI_PTR(activations + 3952);
    conv2d_9_output_array.data = AI_PTR(activations + 0);
    conv2d_9_output_array.data_start = AI_PTR(activations + 0);
    conv2d_11_output_array.data = AI_PTR(activations + 3888);
    conv2d_11_output_array.data_start = AI_PTR(activations + 3888);
    conv2d_13_output_array.data = AI_PTR(activations + 0);
    conv2d_13_output_array.data_start = AI_PTR(activations + 0);
    conv2d_15_output_array.data = AI_PTR(activations + 3824);
    conv2d_15_output_array.data_start = AI_PTR(activations + 3824);
    conv2d_17_output_array.data = AI_PTR(activations + 0);
    conv2d_17_output_array.data_start = AI_PTR(activations + 0);
    conv2d_19_output_array.data = AI_PTR(activations + 3760);
    conv2d_19_output_array.data_start = AI_PTR(activations + 3760);
...
AI_DECLARE_STATIC
ai_bool wn_12_4_tfl_6_configure_weights(
...
AI_API_ENTRY
ai_bool ai_wn_12_4_tfl_6_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_WN_12_4_TFL_6_MODEL_NAME,
      .model_signature   = AI_WN_12_4_TFL_6_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_wn_12_4_tfl_6_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_wn_12_4_tfl_6_create(
...
AI_API_ENTRY
ai_handle ai_wn_12_4_tfl_6_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_wn_12_4_tfl_6_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= wn_12_4_tfl_6_configure_weights(net_ctx, &params->params);
  ok &= wn_12_4_tfl_6_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_wn_12_4_tfl_6_forward(ai_handle network, const ai_buffer* input)
{
