...
#define AI_NET_OBJ_INSTANCE g_wn_10_1
 
#undef AI_WN_10_1_MODEL_SIGNATURE
#define AI_WN_10_1_MODEL_SIGNATURE     "d06a0044a52f4b45781e6e9117399196"
...
#define AI_TOOLS_DATE_TIME   "Thu Dec 10 18:06:13 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_WN_10_1_N_BATCHES
#define AI_WN_10_1_N_BATCHES         (1)
...
AI_STATIC ai_array conv1d_9_bias_array;   /* Array #0 */
AI_STATIC ai_array conv1d_9_weights_array;   /* Array #1 */
AI_STATIC ai_array conv1d_8_bias_array;   /* Array #2 */
AI_STATIC ai_array conv1d_8_weights_array;   /* Array #3 */
AI_STATIC ai_array conv1d_7_bias_array;   /* Array #4 */
AI_STATIC ai_array conv1d_7_weights_array;   /* Array #5 */
AI_STATIC ai_array conv1d_6_bias_array;   /* Array #6 */
AI_STATIC ai_array conv1d_6_weights_array;   /* Array #7 */
AI_STATIC ai_array conv1d_5_bias_array;   /* Array #8 */
AI_STATIC ai_array conv1d_5_weights_array;   /* Array #9 */
AI_STATIC ai_array conv1d_4_bias_array;   /* Array #10 */
AI_STATIC ai_array conv1d_4_weights_array;   /* Array #11 */
AI_STATIC ai_array conv1d_3_bias_array;   /* Array #12 */
AI_STATIC ai_array conv1d_3_weights_array;   /* Array #13 */
AI_STATIC ai_array conv1d_2_bias_array;   /* Array #14 */
AI_STATIC ai_array conv1d_2_weights_array;   /* Array #15 */
AI_STATIC ai_array conv1d_1_bias_array;   /* Array #16 */
AI_STATIC ai_array conv1d_1_weights_array;   /* Array #17 */
AI_STATIC ai_array conv1d_bias_array;   /* Array #18 */
AI_STATIC ai_array conv1d_weights_array;   /* Array #19 */
AI_STATIC ai_array input_0_output_array;   /* Array #20 */
AI_STATIC ai_array conv1d_output_array;   /* Array #21 */
AI_STATIC ai_array conv1d_1_output_array;   /* Array #22 */
AI_STATIC ai_array conv1d_2_output_array;   /* Array #23 */
AI_STATIC ai_array conv1d_3_output_array;   /* Array #24 */
AI_STATIC ai_array conv1d_4_output_array;   /* Array #25 */
AI_STATIC ai_array conv1d_5_output_array;   /* Array #26 */
AI_STATIC ai_array conv1d_6_output_array;   /* Array #27 */
AI_STATIC ai_array conv1d_7_output_array;   /* Array #28 */
AI_STATIC ai_array conv1d_8_output_array;   /* Array #29 */
AI_STATIC ai_array conv1d_9_output_array;   /* Array #30 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor conv1d_9_bias;   /* Tensor #0 */
AI_STATIC ai_tensor conv1d_9_weights;   /* Tensor #1 */
AI_STATIC ai_tensor conv1d_8_bias;   /* Tensor #2 */
AI_STATIC ai_tensor conv1d_8_weights;   /* Tensor #3 */
AI_STATIC ai_tensor conv1d_7_bias;   /* Tensor #4 */
AI_STATIC ai_tensor conv1d_7_weights;   /* Tensor #5 */
AI_STATIC ai_tensor conv1d_6_bias;   /* Tensor #6 */
AI_STATIC ai_tensor conv1d_6_weights;   /* Tensor #7 */
AI_STATIC ai_tensor conv1d_5_bias;   /* Tensor #8 */
AI_STATIC ai_tensor conv1d_5_weights;   /* Tensor #9 */
AI_STATIC ai_tensor conv1d_4_bias;   /* Tensor #10 */
AI_STATIC ai_tensor conv1d_4_weights;   /* Tensor #11 */
AI_STATIC ai_tensor conv1d_3_bias;   /* Tensor #12 */
AI_STATIC ai_tensor conv1d_3_weights;   /* Tensor #13 */
AI_STATIC ai_tensor conv1d_2_bias;   /* Tensor #14 */
AI_STATIC ai_tensor conv1d_2_weights;   /* Tensor #15 */
AI_STATIC ai_tensor conv1d_1_bias;   /* Tensor #16 */
AI_STATIC ai_tensor conv1d_1_weights;   /* Tensor #17 */
AI_STATIC ai_tensor conv1d_bias;   /* Tensor #18 */
AI_STATIC ai_tensor conv1d_weights;   /* Tensor #19 */
AI_STATIC ai_tensor input_0_output;   /* Tensor #20 */
AI_STATIC ai_tensor conv1d_output;   /* Tensor #21 */
AI_STATIC ai_tensor conv1d_1_output;   /* Tensor #22 */
AI_STATIC ai_tensor conv1d_2_output;   /* Tensor #23 */
AI_STATIC ai_tensor conv1d_3_output;   /* Tensor #24 */
AI_STATIC ai_tensor conv1d_4_output;   /* Tensor #25 */
AI_STATIC ai_tensor conv1d_5_output;   /* Tensor #26 */
AI_STATIC ai_tensor conv1d_6_output;   /* Tensor #27 */
AI_STATIC ai_tensor conv1d_7_output;   /* Tensor #28 */
AI_STATIC ai_tensor conv1d_8_output;   /* Tensor #29 */
AI_STATIC ai_tensor conv1d_9_output;   /* Tensor #30 */
...
/* Array#30 */
AI_ARRAY_OBJ_DECLARE(
  conv1d_9_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 127), AI_STRIDE_INIT(4, 4, 4, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 63), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 59), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 51), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 35), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 4256, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_10_1_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN_10_1_OUT_NUM, &conv1d_9_output),
  &conv1d_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool wn_10_1_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_WN_10_1_ACTIVATIONS_ALIGNMENT));
...

  {
    ...
    conv1d_output_array.data = AI_PTR(activations + 256);
    conv1d_output_array.data_start = AI_PTR(activations + 256);
    conv1d_1_output_array.data = AI_PTR(activations + 192);
    conv1d_1_output_array.data_start = AI_PTR(activations + 192);
    conv1d_2_output_array.data = AI_PTR(activations + 128);
    conv1d_2_output_array.data_start = AI_PTR(activations + 128);
    conv1d_3_output_array.data = AI_PTR(activations + 64);
    conv1d_3_output_array.data_start = AI_PTR(activations + 64);
    conv1d_4_output_array.data = AI_PTR(activations + 0);
    conv1d_4_output_array.data_start = AI_PTR(activations + 0);
    conv1d_5_output_array.data = AI_PTR(activations + 2080);
    conv1d_5_output_array.data_start = AI_PTR(activations + 2080);
    conv1d_6_output_array.data = AI_PTR(activations + 0);
    conv1d_6_output_array.data_start = AI_PTR(activations + 0);
    conv1d_7_output_array.data = AI_PTR(activations + 1888);
    conv1d_7_output_array.data_start = AI_PTR(activations + 1888);
    conv1d_8_output_array.data = AI_PTR(activations + 0);
    conv1d_8_output_array.data_start = AI_PTR(activations + 0);
    conv1d_9_output_array.data = AI_PTR(NULL);
    conv1d_9_output_array.data_start = AI_PTR(NULL);
...
AI_DECLARE_STATIC
ai_bool wn_10_1_configure_weights(
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    conv1d_9_bias_array.data = AI_PTR(weights + 6624);
    conv1d_9_bias_array.data_start = AI_PTR(weights + 6624);
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_WN_10_1_MODEL_NAME,
      .model_signature   = AI_WN_10_1_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_wn_10_1_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_wn_10_1_create(
...
AI_API_ENTRY
ai_handle ai_wn_10_1_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_wn_10_1_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= wn_10_1_configure_weights(net_ctx, &params->params);
  ok &= wn_10_1_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_wn_10_1_forward(ai_handle network, const ai_buffer* input)
{
