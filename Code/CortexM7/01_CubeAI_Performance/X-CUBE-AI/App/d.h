...
#define AI_D_MODEL_NAME          "d"

#define AI_D_ACTIVATIONS_ALIGNMENT   (4)

#define AI_D_IN_NUM       (1)
#define AI_D_IN { \
...
#define AI_D_IN_1_SIZE  (253 * 1 * 1)
#define AI_D_IN_1_SIZE_BYTES  ((253 * 1 * 1) * 4)





#define AI_D_OUT_NUM      (1)
#define AI_D_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_D_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_D_OUT_1_SIZE  (1 * 1 * 1)
#define AI_D_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_D_N_NODES (12)
 ...
 * @ref ai_d_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_D_*
 * defines into file @ref d.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
