...
#define AI_NET_OBJ_INSTANCE g_wn12_3
 
#undef AI_WN12_3_MODEL_SIGNATURE
#define AI_WN12_3_MODEL_SIGNATURE     "a7a8574fb79790f12d07830100f57544"
...
#define AI_TOOLS_DATE_TIME   "Sat Dec  5 16:43:51 2020"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_WN12_3_N_BATCHES
#define AI_WN12_3_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 8416, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN12_3_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_WN12_3_OUT_NUM, &conv1d_11_output),
  &conv1d_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool wn12_3_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  AI_ASSERT(net_ctx &&  activation_buffer && activation_buffer->data)

  ai_ptr activations = AI_PTR(AI_PTR_ALIGN(activation_buffer->data, AI_WN12_3_ACTIVATIONS_ALIGNMENT));
...
AI_DECLARE_STATIC
ai_bool wn12_3_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_WN12_3_MODEL_NAME,
      .model_signature   = AI_WN12_3_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= wn12_3_configure_weights(net_ctx, &params->params);
  ok &= wn12_3_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_wn12_3_forward(ai_handle network, const ai_buffer* input)
{
