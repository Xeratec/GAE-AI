...
#ifndef __AI_WAVENET18_H__
#define __AI_WAVENET18_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WAVENET18_MODEL_NAME          "wavenet18"

#define AI_WAVENET18_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WAVENET18_IN_NUM       (1)
#define AI_WAVENET18_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 2045, 1, 1, 1, NULL), \
}
#define AI_WAVENET18_IN_SIZE { \
  (2045 * 1 * 1), \
}
#define AI_WAVENET18_IN_1_SIZE  (2045 * 1 * 1)
#define AI_WAVENET18_IN_1_SIZE_BYTES  ((2045 * 1 * 1) * 4)





#define AI_WAVENET18_OUT_NUM      (1)
#define AI_WAVENET18_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_WAVENET18_OUT_SIZE { \
  (1 * 1 * 1), \
}
#define AI_WAVENET18_OUT_1_SIZE  (1 * 1 * 1)
#define AI_WAVENET18_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_WAVENET18_N_NODES (18)
 ...
 * @ref ai_wavenet18_create. Both the activations memory buffer 
 ...
 * using @ref ai_wavenet18_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_WAVENET18_*
 * defines into file @ref wavenet18.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wavenet18_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WAVENET18_H__*/
